...
set(CTEST_DASHBOARD_ROOT "/users/d_zxg06726/nightlyBuilds/EnGPar_build/" )
...
set(REPO_URL_BASE "https://github.com/SCOREC/EnGPar")
set(BRANCH "master")
...
# set(GROUP_NAME "EnGPar")
set_property(GLOBAL PROPERTY SubProject "EnGPar")
set_property(GLOBAL PROPERTY Label "EnGPar")
...
SET(CONFIGURE_OPTIONS
  "-DCMAKE_INSTALL_PREFIX=${CTEST_DASHBOARD_ROOT}/build-EnGPar/install"
  ...
  "-DENABLE_ZOLTAN=OFF"
  "-DIS_TESTING=ON"
  "-DMESHES=${CTEST_DASHBOARD_ROOT}/pumi-meshes/"
  "-DGRAPHS=${CTEST_DASHBOARD_ROOT}/EnGPar-graphs/"
)
